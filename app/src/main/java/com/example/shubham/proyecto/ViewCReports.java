...
public class ViewCReports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_creports);
...
//        i.getStringExtra("name");
    ...
    {
        Cursor c = sb.query(StudentConstant.TBL_STUDENT, null, StudentConstant.COL_CID+ " =?", args, null, null, null, null);
        {
